...
public class WebinCliExecutorBuilder<M extends Manifest, R extends ValidationResponse> {
  ...
  private static final String AUTH_JSON =
      "{\"authRealms\":[\"ENA\"],\"password\":\"sausages\",\"username\":\"Webin-256\"}";
  ...
  public WebinCliExecutorBuilder(
      Class<M> manifestClass, MetadataProcessorType metadataProcessorType) {
  ...
  private String getAuthToken() {
    ...
    HttpEntity<String> request = new HttpEntity<String>(AUTH_JSON, headers);
