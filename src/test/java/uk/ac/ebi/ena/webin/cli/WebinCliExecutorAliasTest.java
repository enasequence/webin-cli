...
public class WebinCliExecutorAliasTest {
  ...
  public void testGenome() {
    WebinCliExecutor<?> executor =
        WebinCliContext.genome.createExecutor(WebinCliTestUtils.createTestWebinCliParameters());
  ...
  public void testSequence() {
    WebinCliExecutor<?> executor =
            WebinCliContext.sequence.createExecutor(WebinCliTestUtils.createTestWebinCliParameters());
    executor.getManifestReader().getManifest().setName("TEST_NAME  1");
  ...
  public void testTranscriptome() {
    WebinCliExecutor<?> executor =
            WebinCliContext.transcriptome.createExecutor(WebinCliTestUtils.createTestWebinCliParameters());
    executor.getManifestReader().getManifest().setName("TEST_NAME  1");
  ...
  public void testReads() {
    WebinCliExecutor<?> executor =
            WebinCliContext.reads.createExecutor(WebinCliTestUtils.createTestWebinCliParameters());
    executor.getManifestReader().getManifest().setName("TEST_NAME  1");
