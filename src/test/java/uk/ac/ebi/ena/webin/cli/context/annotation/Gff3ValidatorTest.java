 ...
 * submissions reference existing ENA sequences via PRIMARY_ID, so client-side GFF3 validation
 * is structural only. Sequence-level cross-validation happens server-side in
 * webin-gff3-stages.
 */
