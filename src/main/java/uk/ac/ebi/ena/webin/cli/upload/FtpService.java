...
public class FtpService implements UploadService {
    ...
    @Override
    public void upload(List<File> uploadFilesList, String uploadDir, Path inputDir ) throws WebinCliException {
        ...
        try {
            RetryUtils.executeWithRetry((RetryCallback<Void, Exception>) context -> {
                ...
                if (ftpServerWorkingDir != null) {
                    ...
                    // FTP server's working directory is '/' after a fresh connection. So set this as current working directory.
