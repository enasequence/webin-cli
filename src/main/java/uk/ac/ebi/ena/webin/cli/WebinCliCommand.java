...
public class WebinCliCommand {
  ...
  @Option(
      names = {Options.userName, Options.userNameSynonym},
      paramLabel = "USER",
  ...
  @Option(
      names = Options.passwordFile,
      description = Descriptions.passwordFile,
      paramLabel = "FILE",
      order = 3)
  public File passwordFile;

  @Option(
      names = Options.passwordEnv,
      description = Descriptions.passwordEnv,
      paramLabel = "VAR",
      order = 3)
  public String passwordEnv;

  @Option(
      names = {Options.inputDir, Options.inputDirSynonym},
      description = Descriptions.inputDir,
      paramLabel = "DIRECTORY",
      order = 4)
  public File inputDir;

  @Option(
      names = {Options.outputDir, Options.outputDirSynonym},
      description = Descriptions.outputDir,
      paramLabel = "DIRECTORY",
      order = 5)
  public File outputDir;

  @Option(
      names = {Options.centerName, Options.centerNameSynonym},
      description = Descriptions.centerName,
      paramLabel = "CENTER",
      order = 6)
  public String centerName;

  @Option(
      names = Options.validate,
      description = Descriptions.validate,
      defaultValue = "false",
      order = 7)
  public boolean validate;

  @Option(
      names = Options.validateFiles,
      description = Descriptions.validateFiles,
      defaultValue = "false",
      order = 8)
  public boolean validateFiles;

  /**
   * This used to be visible but later marked hidden to prevent users from getting confused when
   * they tried to understand its purpose. It was also set to be true by default around the same
   * time as the shorter validation was deemed reasonably good enough for most use cases.
   */
  @Option(
      names = Options.noQuick,
      description = Descriptions.quick,
      order = 9,
      negatable = true,
      hidden = true)
  ...
  @Option(
      names = Options.sampleUpdate,
      description = Descriptions.sampleUpdate,
      defaultValue = "false",
      order = 102)
  ...
  public interface Descriptions {
    ...
    String manifest = "Manifest text file containing file and metadata fields.";
    ...
    String validateFiles =
        "All manifest fields become optional to allow read file validation without having to provide metadata.";
    String quick =
        "By default, validate submitted BAM & CRAM read files within a fixed time period (5 minutes) "
    ...
    String help = "Show this help message and exit.";
    String fields = "Show manifest fields for all contexts or for the given -context.";
    String version = "Print version information and exit.";
