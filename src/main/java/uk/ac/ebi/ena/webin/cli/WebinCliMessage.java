...
public enum WebinCliMessage implements MessageFormatSource {
    ...
    CLI_VALIDATE_USER_ERROR_NO_REPORT_FILES("Submission validation failed because of a user error: {0}"),
    CLI_VALIDATE_SYSTEM_ERROR_NO_REPORT_FILES("Submission validation failed because of a system error: {0}"),
    CLI_VALIDATE_USER_ERROR_EX_NO_REPORT_FILES("Submission validation failed because of a user error."),
