...
public enum WebinCliMessage implements MessageFormatSource {
    ...
    STUDY_PROCESSOR_LOOKUP_ERROR("Could not find study \"{0}\". The study must be either public or owned by the submission account used for this submission. Note that only a single study can be referenced. {1}"),
    SAMPLE_PROCESSOR_LOOKUP_ERROR("Could not find sample \"{0}\". The sample must be either public or owned by the submission account used for this submission. Note that only a single sample can be referenced. {1}"),
    ...
    CUSTOM_FIELD_PROCESSOR_INCORRECT_FIELD_VALUE("Field \"{0}\" value \"{1}\" format is incorrect \"{2}\". Expected format: \"CUSTOM_FIELD key:value\" ");
