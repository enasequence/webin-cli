...
public interface WebinCliMessage {
    ...
    enum Cli implements WebinCliMessage {
        ...
        VALIDATE_USER_ERROR("Submission validation failed because of a user error: {0}. Please check validation reports for further information in directory: {1}"),
        VALIDATE_SYSTEM_ERROR("Submission validation failed because of a system error: {0}. Please check validation reports for further information in directory: {1}"),
